  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md typo-button-md font-semibold transition-all duration-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-alt focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        secondary: 'border border-border bg-surface-raised text-text hover:bg-surface-sunken',
        ghost: 'hover:bg-surface-sunken text-text-muted hover:text-text',
        link: 'text-accent-alt underline-offset-4 hover:underline',
        tone: 'border-[length:var(--border-print)] border-[var(--tone-border)] bg-[var(--tone-accent)] text-[var(--tone-ink)] shadow-press hover:opacity-90 active:translate-y-[2px] active:shadow-none',
        cart: 'rounded-full border-0 bg-accent text-text-on-brand shadow-none hover:bg-accent-alt hover:text-text-on-brand active:translate-y-0 active:shadow-none',
      },
      size: {
